...
export const IconContainer = styled.div<{ disabled?: any }>`
  display: flex;
  align-items: center;
  width: 170px;
  margin-top: 20px;
...
export const Icontwo = styled(FiMinusSquare)<{ disabled: any }>`
  margin-left: 10px;
  font-size: 20px;
  font-family: "Roboto", sans-serif;
  text-shadow: ${({ disabled }) =>
...
export const TextArea = styled.textarea<{ errorNeon?: any }>`
  font-family: "Roboto", sans-serif;
  width: 450px;
  height: auto;
  min-height: 150px;
