...
export function StartTraining({ training, setStep, highestNumber }: any) {
  ...
  function inputChance(series: any, index: any, id: any, inputValue: any) {
    if (inputValue === "") {
      if (inputData[id]) {
        ...
        if (series !== data[id].index.length) {
          setCheckState(checkState.filter((item: any) => item !== id));
        }
      }
    }
  ...
  function inputChanceCircuits(index: any, id: any, inputValue: any) {
    if (inputValue === "") {
      if (inputData[index]) {
        ...
        if (training.exercises.length !== data[index].id.length) {
          setCheckState(checkState.filter((item: any) => item !== index));
        }
      }
    }
